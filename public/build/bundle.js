...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1fxrib7");
    			add_location(h1, file$3, 1, 0, 2);
    			attr_dev(summary, "class", "svelte-1fxrib7");
    			add_location(summary, file$3, 3, 4, 82);
    			add_location(li0, file$3, 8, 12, 349);
    			add_location(li1, file$3, 9, 12, 408);
    			add_location(li2, file$3, 13, 20, 585);
    			add_location(li3, file$3, 14, 20, 654);
    			add_location(li4, file$3, 15, 20, 745);
    			add_location(ol0, file$3, 12, 16, 559);
    			add_location(li5, file$3, 10, 12, 463);
    			add_location(ol1, file$3, 7, 8, 331);
    			add_location(br, file$3, 20, 8, 936);
    			attr_dev(a, "href", "https://en.wikipedia.org/wiki/Maze_generation_algorithm#Randomized_depth-first_search");
    			attr_dev(a, "target", "_blank");
    			attr_dev(a, "rel", "noopener noreferrer");
    			add_location(a, file$3, 21, 8, 952);
    			attr_dev(div, "class", "content svelte-1fxrib7");
    			add_location(div, file$3, 5, 4, 135);
    			attr_dev(details, "class", "svelte-1fxrib7");
    ...
    function create_each_block_1(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			td = element("td");
    			attr_dev(td, "class", "svelte-12kdwz4");
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(header1, "class", "svelte-12kdwz4");
    			...
    			attr_dev(main, "class", "svelte-12kdwz4");
    			add_location(main, file, 75, 0, 2847);
    			attr_dev(aside, "class", "svelte-12kdwz4");
